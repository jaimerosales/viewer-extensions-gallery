...
//
///////////////////////////////////////////////////////////////////
function TransformToolExtension(viewer, options) {
    Autodesk.Viewing.Extension.call(this, viewer, options);
    this.panel = null; // create the panel variable
}

TransformToolExtension.prototype = Object.create(Autodesk.Viewing.Extension.prototype);
TransformToolExtension.prototype.constructor = TransformToolExtension;
  
TransformToolExtension.prototype.load = function () {
  ...
  TransformToolExtension.prototype.onToolbarCreated = function () {
    this.viewer.removeEventListener(Autodesk.Viewing.TOOLBAR_CREATED_EVENT, this.onToolbarCreatedBinded);
    this.onToolbarCreatedBinded = null;
    this.createUI();
  };
  
  TransformToolExtension.prototype.createUI = function () {
    var _this = this;
  
    // prepare to execute the button action
    var TransformToolToolbarButton = new Autodesk.Viewing.UI.Button('runTransformCode');
    TransformToolToolbarButton.onClick = function (e) {
    ...
    TransformToolToolbarButton.addClass('TransformToolToolbarButton');
    TransformToolToolbarButton.setToolTip('Transform Tool');
  
    // SubToolbar
    this.subToolbar = (this.viewer.toolbar.getControl("MyAppToolbar") ?
      this.viewer.toolbar.getControl("MyAppToolbar") :
      new Autodesk.Viewing.UI.ControlGroup('MyAppToolbar'));
    this.subToolbar.addControl(TransformToolToolbarButton);
  
    this.viewer.toolbar.addControl(this.subToolbar);
  };
  
  TransformToolExtension.prototype.unload = function () {
    this.viewer.toolbar.removeControl(this.subToolbar);
    return true;
  };
  
  Autodesk.Viewing.theExtensionManager.registerExtension('TransformToolExtension', TransformToolExtension);
...
// Autodesk.ADN.Viewing.Extension.TransformToolExtension =  function (viewer, options) {

//     ///////////////////////////////////////////////////////////////////////////
//     //
//     //
//     ///////////////////////////////////////////////////////////////////////////
//     function TransformToolExtension() {
...
//         _self.tool = new TransformToolExtension();

//         viewer.toolController.registerTool(_self.tool);

//         viewer.toolController.activateTool(_self.tool.getName());

//         console.log('Autodesk.ADN.Viewing.Extension.TransformToolExtension loaded');
...
//         console.log('Autodesk.ADN.Viewing.Extension.TransformToolExtension unloaded');
...
// Autodesk.ADN.Viewing.Extension.TransformToolExtension.prototype =
//     Object.create(Autodesk.Viewing.Extension.prototype);

// Autodesk.ADN.Viewing.Extension.TransformToolExtension.prototype.constructor =
//     Autodesk.ADN.Viewing.Extension.TransformToolExtension;
